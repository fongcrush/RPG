...
#define LOG_WITH_CALLINFO(Format, ...) UE_LOG(RPG, Log, TEXT("%s %s"), *CALLINFO_S, *FString::Printf(TEXT(Format), ##__VA_ARGS__))
#define LOG_WARNING_WITH_CALLINFO(Format, ...) UE_LOG(RPG, Warning, TEXT("%s %s"), *CALLINFO_S, *FString::Printf(TEXT(Format), ##__VA_ARGS__))
#define LOG_ERROR_WITH_CALLINFO(Format, ...) UE_LOG(RPG, Error, TEXT("%s %s"), *CALLINFO_S, *FString::Printf(TEXT(Format), ##__VA_ARGS__))
