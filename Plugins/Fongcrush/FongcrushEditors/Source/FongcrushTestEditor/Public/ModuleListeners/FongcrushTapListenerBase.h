...
#include "FongcrushModuleBase.h"

/**
 * 
 */
class FONGCRUSHTESTEDITOR_API FFongcrushTapListenerBase : public IModuleListener, public TSharedFromThis<FFongcrushTapListenerBase>
{
public:
