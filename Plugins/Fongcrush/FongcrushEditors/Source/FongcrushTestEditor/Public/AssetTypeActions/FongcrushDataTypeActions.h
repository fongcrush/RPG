 ...
 *		
 *		EAssetTypeCategories::Type Category = AssetTools.RegisterAdvancedAssetCategory(FName("Fongcrush"),FText::FromString(TEXT("퐁크러시")));
 *		
 *		AssetTools.RegisterAssetTypeActions(MakeShared<FFongcrushDataTypeActions>(Category, UFongcrushTestData::StaticClass()).ToSharedRef());
*/
class FFongcrushDataTypeActions : public FAssetTypeActions_Base
{
public:
	FFongcrushDataTypeActions(EAssetTypeCategories::Type InAssetCategory, UClass* InClassType)
	...
	void ExecuteReimport(TArray<TWeakObjectPtr<UFongcrushTestData>> Objects);
